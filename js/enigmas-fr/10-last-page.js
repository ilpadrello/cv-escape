export default [
  ...
  },
  {
    html: `
    <br>
    <p>J'espère que vous vous êtes amusé à en apprendre davantage sur moi !</p>
    <p>C'était amusant à developper aussi !</p>
    <br>
    <p>J'ai réalisé tout ce travail en seulement un week-end</p>
    <p>J'espère vraiment que vous envisagerez ma candidature, je pense sincèrement être la personne idéale pour vous</p>
    <br>
    <p>Pour toute question ou contact ultérieur, n'hésitez pas à m'appeler au '+33 6 59 24 29 54'</p>
    <br>
...
`,
  },
  {
    ...
    <p style="font-size:1.5em"><a href="https://youtu.be/NCyHkZtT9tM" target="_blank">Explication du documentaire 🎬</a><p>
    </br>
